...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, MUX_PIN_A_Pin|MUX_PIN_B_Pin|MUX_PIN_C_Pin|FAULT_LED1_Pin
                          |FAULT_LED2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : MUX_PIN_A_Pin MUX_PIN_B_Pin MUX_PIN_C_Pin FAULT_LED1_Pin
                           FAULT_LED2_Pin */
  GPIO_InitStruct.Pin = MUX_PIN_A_Pin|MUX_PIN_B_Pin|MUX_PIN_C_Pin|FAULT_LED1_Pin
                          |FAULT_LED2_Pin;
